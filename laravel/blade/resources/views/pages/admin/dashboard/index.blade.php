...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <x-admin.ui.title title="Dashboard" />
    ...
    <div class="row">
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            >
                <div class="d-flex align-items-center justify-content-between">
                    <span class="fs-12 fw-medium text-muted text-truncate-1-line">Invoices Awaiting</span>
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            >
                <div class="d-flex align-items-center justify-content-between">
                    <span class="fs-12 fw-medium text-muted text-truncate-1-line">Converted Leads</span>
                    <div class="w-100 text-end">
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            >
                <div class="d-flex align-items-center justify-content-between">
                    <span class="fs-12 fw-medium text-muted text-truncate-1-line">Projects In Progress</span>
                    <div class="w-100 text-end">
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            >
                <div class="d-flex align-items-center justify-content-between">
                    <span class="fs-12 fw-medium text-muted text-truncate-1-line">Conversion Rate</span>
                    <div class="w-100 text-end">
            ...
            <div class="card stretch stretch-full overflow-hidden">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="hstack gap-3">
                            <div class="avatar-image avatar-lg p-2 rounded">
                                <img class="img-fluid" src="{{ asset('assets/admin/images/brand/shopify.png') }}" alt="" />
                            </div>
                            <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="hstack gap-3">
                            <div class="avatar-image avatar-lg p-2 rounded">
                                <img class="img-fluid" src="{{ asset('assets/admin/images/brand/app-store.png') }}" alt="" />
                            </div>
                            <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="hstack gap-3">
                            <div class="avatar-image avatar-lg p-2 rounded">
                                <img class="img-fluid" src="{{ asset('assets/admin/images/brand/figma.png') }}" alt="" />
                            </div>
                            <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image">
                                                <img src="{{ asset('assets/admin/images/avatar/6.png') }}" alt="" class="img-fluid" />
                                            </div>
                                            <a href="javascript:void(0);">
                    ...
                    <div class="p-3 border border-dashed rounded-3 mb-3">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="img-group lh-0 ms-3 justify-content-start d-none d-sm-flex">
                                ...
                                <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                    <img src="{{ asset('assets/admin/images/avatar/5.png') }}" class="img-fluid" alt="image" />
                                </a>
                                <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                    <img src="{{ asset('assets/admin/images/avatar/6.png') }}" class="img-fluid" alt="image" />
                                </a>
                    ...
                    <div class="mb-3">
                        <div class="mb-4 pb-1 d-flex">
                            <div class="d-flex w-50 align-items-center me-3">
                                <img src="{{ asset('assets/admin/images/brand/app-store.png') }}" alt="laravel-logo" class="me-3" width="35" />
                                <div>
                        ...
                        <div class="mb-4 pb-1 d-flex">
                            <div class="d-flex w-50 align-items-center me-3">
                                <img src="{{ asset('assets/admin/images/brand/figma.png') }}" alt="figma-logo" class="me-3" width="35" />
                                <div>
                        ...
                        <div class="mb-4 pb-1 d-flex">
                            <div class="d-flex w-50 align-items-center me-3">
                                <img src="{{ asset('assets/admin/images/brand/facebook.png') }}" alt="vue-logo" class="me-3" width="35" />
                                <div>
                        ...
                        <div class="mb-4 pb-1 d-flex">
                            <div class="d-flex w-50 align-items-center me-3">
                                <img src="{{ asset('assets/admin/images/brand/github.png') }}" alt="react-logo" class="me-3" width="35" />
                                <div>
                        ...
                        <div class="d-flex">
                            <div class="d-flex w-50 align-items-center me-3">
                                <img src="{{ asset('assets/admin/images/brand/paypal.png') }}" alt="sketch-logo" class="me-3" width="35" />
                                <div>
